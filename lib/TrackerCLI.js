...
class TrackerCLI {
    ...
    */
    ...
    // Add department menu method. Ask for a department name and then adds it to the database via addDept method
    ...
    // Add role menu method. depts is an array of {name, id} objects. Asks for role name, role salary, and provides a list of departments to choose from. Adds to database via addRole method.
    ...
    // Add employee menu. roles is an array of {roleName, id} objects. employees is an array of {firstname, lastName, id} objects. Asks for first name and last name. Role and manager are chosen from lists. Adds to database via addEmployee method.
    ...
    // Update employee role menu. employees is an array of {firstName, lastName, id} objects. roles is an array of {roleName, id} objects. Select an employee and a role from a list of each. Updates database via updateEmployeeRole method.
